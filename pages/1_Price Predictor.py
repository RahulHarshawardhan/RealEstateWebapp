...
property_age = st.selectbox('agePossession', sorted(df['agePossession'].unique().tolist()))

built_up_area = float(st.number_input('built_up_area'))

servant_room = int(st.selectbox('servant room', [0.0, 1.0]))

store_room = int(st.selectbox('store room', [0.0, 1.0]))
